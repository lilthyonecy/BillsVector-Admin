...
function services(props) {
  ...
  return (
    <Layout>
      <h1 className="m-5">All Service</h1>
      <div className="grid grid-cols-4 gap-4 m-5">
        <div className="bg-white rounded-lg p-2">
          Airtime
          <BtnManage style={btnClassname} href={"/services/airtime"} />
        </div>
        <div className="bg-white rounded-lg p-2">
          Data
          <BtnManage style={btnClassname} href={"/services/data"} />
        </div>
        <div className="bg-white rounded-lg p-2">
          TV
          <BtnManage style={btnClassname} href={"/services"} />
        </div>
        <div className="bg-white rounded-lg p-2">
          Internet
          <BtnManage style={btnClassname} href={"/services"} />
